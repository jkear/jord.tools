        ...
        <LiquidGlass borderRadius={50} blur={1.5} brightness={0.75} contrast={1.2} shadowIntensity={4} elasticity={0.2} displacementScale={20} className="flex flex-col h-full">
            ...
            */}
            <div className="flex justify-between items-start mb-4">
                {/* 
                   tailwind: xl text size, semi-bold font
            ...
            {/* 
               tailwind: muted foreground color, margin bottom 1.5rem, grow to fill space
               .css: color: hsl(var(--muted-foreground)); margin-bottom: 1.5rem; flex-grow: 1;
            */}
